            ...
            >
              <TiltedCard className="w-full">
                <Link href="/login" className="block group w-full outline-none">
                  <div className="relative rounded-[2.5rem] shadow-lg h-[450px] flex flex-col border border-white/10 overflow-hidden">
                    ...
                    <div className="absolute top-6 right-6 z-10 bg-white/20 backdrop-blur-md p-4 rounded-3xl border border-white/30">
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center p-8 bg-card border border-border rounded-3xl transition-all">
                <div className={`p-4 rounded-2xl mb-4 ${item.color} bg-slate-500/10`}>{item.icon}</div>
                <div className="text-4xl font-black mb-2 flex items-center gap-1 transition-colors text-foreground">
                  <span>+</span>
