...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col bg-[#f0f9ff] dark:bg-slate-950 overflow-hidden">
      ...
      {/* ===================== LOGIN SECTION ===================== */}
<section className="relative min-h-screen w-full flex flex-col items-center justify-start pt-48 pb-20 overflow-y-auto bg-[#f0f9ff] dark:bg-slate-950
  /* إضافة الخلفية المنقطة هنا */
  ...
  >
    ...
    {/* زر العودة للرئيسية - تم تعديل لون الخط للأبيض مع تحديد أسود */}
