...
export default function KidsContinentsHub() {
  ...
  const playSound = (src: string) => {
    ...
    // إضافة catch عشان متصفحات الموبايل بتمنع الصوت أحياناً لو مفيش تفاعل
  ...
  return (
    // 🌟 تم إضافة overflow-y-auto للموبايل و lg:overflow-hidden للكمبيوتر 🌟
    <div className="relative min-h-screen w-full overflow-x-hidden overflow-y-auto lg:overflow-hidden flex flex-col items-center select-none bg-black pb-20 lg:pb-0" dir="rtl">
      ...
      {/* الخلفية: فيديو متحرك مع طبقة تعتيم (Fixed عشان تفضل ثابتة مع السكرول في الموبايل) */}
      ...
      {/* ======================================================== */}
      {/* 🌟 1. تصميم الموبايل: القارات تحت بعض (يظهر في الموبايل فقط) 🌟 */}
      {/* ======================================================== */}
      <div className="flex lg:hidden flex-col items-center justify-center gap-24 w-full z-10 px-4 pt-10">
        {continents.map((continent) => (
          <motion.div
            ...
            onClick={() => {
              // 🌟 في الموبايل: الضغطة بتشغل الصوت وتفتح النافذة
              playSound(continent.clickAudio);
              setSelectedId(continent.id);
            }}
          >
            {/* هالة ضوئية خلف القارة في الموبايل */}
      ...
      {/* ======================================================== */}
      {/* 🌟 2. تصميم الكمبيوتر: خريطة كاملة (يظهر في الشاشات الكبيرة فقط) 🌟 */}
      {/* ======================================================== */}
      ...
      {/* 🌟 النافذة المنبثقة (Modal) - متوافقة مع الموبايل والكمبيوتر 🌟 */}
